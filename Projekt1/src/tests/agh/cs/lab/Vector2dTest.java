...
public class Vector2dTest {
    ...
    public void testWrapBy(){
        Assert.assertEquals(new Vector2d(-1,-1).wrapBy(new Vector2d(0,0), new Vector2d(4,4)), new Vector2d(4,4));
        Assert.assertEquals(new Vector2d(5,5).wrapBy(new Vector2d(0,0), new Vector2d(4,4)), new Vector2d(0,0));
        Assert.assertEquals(new Vector2d(-1,5).wrapBy(new Vector2d(0,0), new Vector2d(4,4)), new Vector2d(4,0));
        Assert.assertEquals(new Vector2d(5,-1).wrapBy(new Vector2d(0,0), new Vector2d(4,4)), new Vector2d(0,4));
